...
import { InspectionModals } from '@/components/inbox/InspectionModals';
import { ProposalModals } from '@/components/inbox/ProposalModals';
import { DeliveryModals } from '@/components/inbox/DeliveryModals';
...
export default function InboxScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <InspectionModals
        showInspectionRequest={showInspectionRequest}
        setShowInspectionRequest={setShowInspectionRequest}
        showInspectionResult={showInspectionResult}
        setShowInspectionResult={setShowInspectionResult}
        showInspectionRejected={showInspectionRejected}
        setShowInspectionRejected={setShowInspectionRejected}
        showShippingInstructions={showShippingInstructions}
        setShowShippingInstructions={setShowShippingInstructions}
        setShowOfferDetails={setShowOfferDetails}
      ...
      <ProposalModals
        ...
        setShowProposalSuccess={setShowProposalSuccess}
        showProposalRejected={showProposalRejected}
        setShowProposalRejected={setShowProposalRejected}
        checkUserStatusAndFetch={() => checkUserStatusAndFetch(true)}
        API_URL={API_URL}
      />

      <DeliveryModals
        showBidWon={showBidWon}
        setShowBidWon={setShowBidWon}
        wonItemDetails={wonItemDetails}
        setShowDeliverySelection={setShowDeliverySelection}
        showDeliverySelection={showDeliverySelection}
        deliveryType={deliveryType}
        setDeliveryType={setDeliveryType}
        setShowWonInvoice={setShowWonInvoice}
        showWonInvoice={showWonInvoice}
        showDeliverySuccess={showDeliverySuccess}
        setShowDeliverySuccess={setShowDeliverySuccess}
        loggedInUserId={loggedInUserId}
        checkUserStatusAndFetch={() => checkUserStatusAndFetch(true)}
        API_URL={API_URL}
      />
